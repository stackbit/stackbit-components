...
export const parameters = {
    ...
    options: {
        storySort: {
            order: ['Layouts', ['Advanced Page', 'Post'], 'Components', ['Navigation Bar', 'Footer', 'Contact Section', 'Content Section', 'CTA Section', 'Featured Posts Section', 'Hero Section', 'Testimonials Section'], 'Atoms']
        }
    },
