            ...
            <div className="flex flex-wrap">
                <div
                    className={classNames('w-full md:w-1/2', {
                        'mt-8 md:mt-0 md:pl-8': imagePosition === 'left',
                        'mb-8 md:mb-0 md:pr-8': imagePosition === 'right',
                ...
                >
                    ...
                    >
                        ...
                        <div className="mt-4 sm:mt-8">
                            <button type="submit" className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none">{props.submitLabel}</button>
                        </div>
                    </form>
                </div>
                {props.imageUrl && (
                    <div
                        className={classNames('w-full md:w-1/2', {
                            'order-first': imagePosition === 'left'
                        })}
                    >
